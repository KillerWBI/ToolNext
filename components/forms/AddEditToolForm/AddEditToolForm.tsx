                        ...
                        if (mode === "edit" && initialTool?._id) {
                            ...
                            if (selectedFiles.length > 0) {
                                ...
                                try {
                                    ...
                                    const uploaded: string[] = Array.isArray(
                                        payload?.urls
                                    )
                                        ? payload.urls
                                        : [];
